...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_PORT", "3930");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        ...
        envVars.put("HY2_PORT", "3931");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "3932");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
